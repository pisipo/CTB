...
public class CreateTorusKnot : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        Utils.SaveMesh<PrimitivesPro.GameObjects.TorusKnot>(this);

        Utils.SavePrefab<PrimitivesPro.GameObjects.TorusKnot>(this);

        Utils.DuplicateObject<PrimitivesPro.GameObjects.TorusKnot>(this);
