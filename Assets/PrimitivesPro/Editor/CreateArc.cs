...
public class CreateArc : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        Utils.SaveMesh<PrimitivesPro.GameObjects.Arc>(this);

        Utils.SavePrefab<PrimitivesPro.GameObjects.Arc>(this);

        Utils.DuplicateObject<PrimitivesPro.GameObjects.Arc>(this);
