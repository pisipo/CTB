...
public class CreateTube : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        Utils.SaveMesh<PrimitivesPro.GameObjects.Tube>(this);

        Utils.SavePrefab<PrimitivesPro.GameObjects.Tube>(this);

        Utils.DuplicateObject<PrimitivesPro.GameObjects.Tube>(this);
