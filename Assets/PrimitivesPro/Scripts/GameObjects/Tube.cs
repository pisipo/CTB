    ...
    public class Tube : BaseObject
    {
        ...
        public override void GenerateColliderGeometry()
        {
            ...
            if (meshCollider && meshFilter)
            {
                ...
                Primitives.TubePrimitive.GenerateGeometry(meshCollider.sharedMesh, radius0, radius1, height, sides, heightSegments, slice, radialMapping, normalsType, pivotPosition);
