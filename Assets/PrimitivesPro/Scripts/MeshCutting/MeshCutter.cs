...
namespace PrimitivesPro.MeshCutting
{
    public class MeshCutter
    {
        ...
        public float Cut(GameObject obj, Utils.Plane plane, bool triangulateHoles, bool deleteOriginal, out GameObject cut0, out GameObject cut1)
        {
            ...
            if (useCentroid)
            {
                ms = Cut(meshToCut, obj.transform, plane, triangulateHoles, out mesh0, out mesh1, out centroid0, out centroid1);
            }
            else
            {
                ms = Cut(meshToCut, obj.transform, plane, triangulateHoles, out mesh0, out mesh1);
            }
        ...
        {
            Vector3 c0, c1;
            List<Vector3[]> conourList;
            return Cut(mesh, meshTransform, plane, triangulateHoles, false, false, out mesh0, out mesh1, out c0, out c1, out conourList);
        }
        ...
        /// <returns>processing time</returns>
        public float Cut(Mesh mesh, Transform meshTransform, Utils.Plane plane, bool triangulateHoles, out Mesh mesh0, out Mesh mesh1, out Vector3 centroid0, out Vector3 centroid1)
        {
            List<Vector3[]> conourList;
            return Cut(mesh, meshTransform, plane, triangulateHoles, true, false, out mesh0, out mesh1, out centroid0, out centroid1, out conourList);
        }
        ...
        /// <param name="mesh1">second part of the new mesh</param>
        /// <param name="triangulateHoles">flag for triangulation of holes</param>
        /// <param name="contoursList">list of contours</param>
        /// <returns>processing time</returns>
        public float Cut(Mesh mesh, Transform meshTransform, Utils.Plane plane, bool triangulateHoles, out Mesh mesh0, out Mesh mesh1, out List<Vector3[]> contoursList)
        {
            Vector3 c0, c1;
            return Cut(mesh, meshTransform, plane, triangulateHoles, false, true, out mesh0, out mesh1, out c0, out c1, out contoursList);
        }
