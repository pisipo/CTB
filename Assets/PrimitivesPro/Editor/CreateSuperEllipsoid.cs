...
public class CreateSuperEllipsoid : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        Utils.SaveMesh<PrimitivesPro.GameObjects.SuperEllipsoid>(this);

        Utils.SavePrefab<PrimitivesPro.GameObjects.SuperEllipsoid>(this);

        Utils.DuplicateObject<PrimitivesPro.GameObjects.SuperEllipsoid>(this);
