...
namespace PrimitivesPro.GameObjects
{
    ...
    public class Torus : BaseObject
    {
        ...
        public static Torus Create(float radius0, float radius1, int torusSegments, int coneSegments, NormalsType normalsType, PivotPosition pivotPosition)
        {
            ...
            torus.GenerateGeometry(radius0, radius1, torusSegments, coneSegments, normalsType, pivotPosition);
        ...
        /// <param name="normalsType">type of normals to be generated</param>
        /// <param name="pivotPosition">position of the model pivot</param>
        public void GenerateGeometry(float radius0, float radius1, int torusSegments, int coneSegments, NormalsType normalsType, PivotPosition pivotPosition)
        {
            ...
            // generate geometry
            GenerationTimeMS = Primitives.TorusPrimitive.GenerateGeometry(mesh, radius0, radius1, torusSegments, coneSegments, normalsType, pivotPosition);
        ...
        {
            GenerateGeometry(radius0, radius1, torusSegments, coneSegments, normalsType, pivotPosition);
        }
        ...
        public override void GenerateColliderGeometry()
        {
            ...
            if (meshCollider && meshFilter)
            {
                ...
                Primitives.TorusPrimitive.GenerateGeometry(meshCollider.sharedMesh, radius0, radius1, torusSegments, coneSegments, normalsType, pivotPosition);
