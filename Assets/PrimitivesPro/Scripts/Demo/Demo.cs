...
//    private Vector3 nextPosition = new Vector3(16, 0.1f, 3);
    ...
    public void OnButtonHit(int id)
    {
        ...
        switch (id)
        {
            ...
            case 4:
                shapeObject = Box.Create(1f, 1f, 1f, 1, 1, 1, false, PivotPosition.Botttom);
            ...
            case 6:
                shapeObject = Cone.Create(1, 0, 2, 3, 10, flatNormals ? NormalsType.Face : NormalsType.Vertex,
                                          PivotPosition.Botttom);
            ...
            case 12:
                shapeObject = Capsule.Create(1f, 1f, 4, 1, flatNormals ? NormalsType.Face : NormalsType.Vertex,
                                             PivotPosition.Botttom);
            ...
            case 14:
                shapeObject = Torus.Create(1f, 0.5f, 4, 4, flatNormals ? NormalsType.Face : NormalsType.Vertex,
                                           PivotPosition.Botttom);
        ...
        if (shapeMain != null)
        {
            ...
            if (animTimeout > 0)
            {
                ...
                switch (shapeID)
                {
                    ...
                    case 6:
                        ((Cone) shapeMain).GenerateGeometry(shapeParams[0], shapeParams[1], shapeParams[2],
