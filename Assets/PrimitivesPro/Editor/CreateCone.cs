...
public class CreateCone : Editor
{
    ...
    static void Create()
    {
        var obj = PrimitivesPro.GameObjects.Cone.Create(2, 0, 2, 20, 1, NormalsType.Vertex, PivotPosition.Center);
        obj.SaveStateAll();
    ...
    public override void  OnInspectorGUI()
    {
        ...
        Utils.SaveMesh<PrimitivesPro.GameObjects.Cone>(this);

        Utils.SavePrefab<PrimitivesPro.GameObjects.Cone>(this);

        Utils.DuplicateObject<PrimitivesPro.GameObjects.Cone>(this);
