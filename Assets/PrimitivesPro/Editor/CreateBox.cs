...
public class CreateBox : Editor
{
    ...
    static void Create()
    {
        var obj = PrimitivesPro.GameObjects.Box.Create(1, 1, 1, 1, 1, 1, false, PivotPosition.Center);
        obj.SaveStateAll();
    ...
    public override void OnInspectorGUI()
    {
        ...
        Utils.SaveMesh<PrimitivesPro.GameObjects.Box>(this);

        Utils.SavePrefab<PrimitivesPro.GameObjects.Box>(this);
