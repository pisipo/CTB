...
public class CreatePyramid : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        Utils.SaveMesh<PrimitivesPro.GameObjects.Pyramid>(this);

        Utils.SavePrefab<PrimitivesPro.GameObjects.Pyramid>(this);

        Utils.DuplicateObject<PrimitivesPro.GameObjects.Pyramid>(this);
