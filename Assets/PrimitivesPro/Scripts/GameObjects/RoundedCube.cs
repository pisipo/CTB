    ...
    public class RoundedCube : BaseObject
    {
        ...
        public override void GenerateColliderGeometry()
        {
            ...
            if (meshCollider && meshFilter)
            {
                ...
                Primitives.SuperEllipsoidPrimitive.GenerateGeometry(meshCollider.sharedMesh, width, height, length, segments, roundness, roundness, normalsType, pivotPosition);
