...
public class CreatePlane : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        Utils.SaveMesh<PrimitivesPro.GameObjects.PlaneObject>(this);

        Utils.SavePrefab<PrimitivesPro.GameObjects.PlaneObject>(this);

        Utils.DuplicateObject<PrimitivesPro.GameObjects.PlaneObject>(this);
