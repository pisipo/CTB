...
namespace PrimitivesPro.Primitives
{
    ...
    public class CapsulePrimitive : Primitive
    {
        ...
        public static float GenerateGeometry(Mesh mesh, float radius, float height, int sides, int heightSegments, NormalsType normalsType, PivotPosition pivotPosition)
        {
            ...
            var sphereRadius = radius + height/2;

            var pivotOffset = Vector3.zero;
            switch (pivotPosition)
            {
                case PivotPosition.Botttom: pivotOffset = new Vector3(0.0f, sphereRadius, 0.0f);
                    break;
                case PivotPosition.Top: pivotOffset = new Vector3(0.0f, -sphereRadius, 0.0f);
                    break;
            }
