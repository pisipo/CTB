    ...
    public class Pyramid : BaseObject
    {
        ...
        public override void GenerateColliderGeometry()
        {
            ...
            if (meshCollider && meshFilter)
            {
                ...
                Primitives.PyramidPrimitive.GenerateGeometry(meshCollider.sharedMesh, width, height, depth, widthSegments, heightSegments, depthSegments, pyramidMap, pivotPosition);
